...
export USE_CCACHE=1
ccache -M 40G # It took only 6.4GB for mido
...
tg(){
	bot_api=1881281633:AAFLmb1P5D1VR810_f52Eae9uXsmr4gVnao # Your tg bot api, dont use my one haha, it's better to encrypt bot api too.
...
id=1309714509 # Your telegram id
...
make bacon -j10 \
	&& send_zip=$(up out/target/product/RMX2001/*zip) && tg $id "Build Succeed!
$send_zip" \
